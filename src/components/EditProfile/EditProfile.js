...
const options = [
  ...
  {
    value: "Pflage/ Taking care of Seniors",
    label: "Pflage/ Taking care of Seniors",
  },
];
...
class EditProfile extends Component {
  ...
  editProfile = (event) => {
    ...
    axios
      ...
      .then((res) =>
        this.props.history.push(`/profile/${this.state.user.profile}`)
      );
  };
      ...
      <div style={{ height: "auto", width: "auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <div style={{ width: "328px" }}>
            ...
            <label className="label_profile" htmlFor="gender">
              Gender
            </label>
            <select
              name="gender"
            ...
            >
              <option
                style={{ backgroundColor: "#F9F8F8", fontFamily: "Montserrat" }}
                value=""
                disabled
                selected
              >
            ...
            <label htmlFor="district" className="label_profile">
              About me (max 120 signs)
            </label>
            <textarea
              type="text"
              name="description"
            ...
            <label className="label_profile" htmlFor="select">
              Prefered district
            </label>
            <select
              name="district"
            ...
            >
              ...
              <option value="Tempelhof-Schoeneberg">
            ...
            <div className="warning" style={{ marginTop: "2vh" }}>
              <p>
                By creating a request, you agree to our Terms and Conditions and
                Data Privacy Policy.
              </p>
            </div>
