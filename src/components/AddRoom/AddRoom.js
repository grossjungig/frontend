      ...
      <div className="div_warning_1_addRoom" >
        <div className="div_warning_2_addRoom" >
          <div className="warning_addRoom" >
            <p >{addRoomLocales.personalInformation[lang]}</p>
          </div>
        </div>
        <div className="main_div_addRoom" >
          <div className="main_div_2_addRoom">
            ...
            {/* ******* * DISTRICT * ******** */}
            <label className="label_profile" htmlFor="district">{addRoomLocales.district[lang]}</label>
            <select
              name="district"
              type="select"
              ...
              placeholder="Select"
            >
              <option value="" disabled selected>{addRoomLocales.select[lang]}</option>
            ...
            {/* ******* * PHONE NUMBER * ******** */}
            <label className="label_room" htmlFor="phoneNumber">{addRoomLocales.name[lang]}</label>
            <input
              type="number"
              name="phoneNumber"
              id="phoneNumber"
            ...
            {/* ******* * EMAIL * ******** */}
            <label className="label_room" htmlFor="email">{addRoomLocales.email[lang]}</label>
            <input
              type="text"
              name="email"
              id="email"
            ...
            {/* ******* * NEIOGHBOURHOOD * ******** */}
            <label className="label_room" htmlFor="neighbourhood">{addRoomLocales.name[lang]}</label>
            <input
              type="text"
              name="neighbourhood"
              id="neighbourhood"
            ...
            <Link to={`/profile`}>
              <button type="submit" className="button_room button_room_cancel" >Cancel{addRoomLocales.cancel[lang]}</button>
              </Link>
